...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/webpacker/blob/v4.0.2/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/webpacker/tree/v4.0.2" } if s.respond_to? :metadata=
